# Learning Roadmap – Agentic AI & Cloud 🚀 Hi_123
...
- Git & GitHub workflow
- Using LLM APIs (OpenAI / similar)
- LangChain / agent frameworks (intro level)
...
- AI agents for cloud automation
- AI-assisted monitoring or reporting
...
- Clean README files for every project
- Learning by building, not just reading
- Sharing progress publicly on GitHub
